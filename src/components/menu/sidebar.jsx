...
export default function Sidebar() {
  ...
  const fetchCarrito = async () => {
    ...
    const total_precio = productos_validos.reduce(
  ...
  const toggleDrawer = () => {
    document.getElementById("my-drawer-1").checked =
      !document.getElementById("my-drawer-1").checked;
  };
    ...
    <div className="drawer drawer-end">
      ...
      <div className="drawer-content">
        <button
          ...
          className="p-2 rounded-full hover:bg-gray-200 drawer-button"
        >
          <div className="relative">
            <ShoppingCart size={25} />
            <div className="badge badge-error badge-xs absolute -top-2 -right-2 p-2 rounded-full">
              {total_count}
            </div>
          </div>
        </button>
